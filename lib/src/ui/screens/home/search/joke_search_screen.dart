import 'package:chuck/src/business/joke_search_provider.dart';
...
class JokeSearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => JokeSearchProvider(),
      child: _JokeSearch(),
    );
  }
}
...
class _SearchFieldViewState extends State<_SearchFieldView> {
  ...
  void _performSearch() {
    ...
    context.read<JokeSearchProvider>().jokeSearch(textEditingController.text);
  }
...
class _SearchResultsState extends State<_SearchResults> {
  ...
  Widget build(BuildContext context) {
    ...
    JokeSearchProvider provider = Provider.of<JokeSearchProvider>(context);
    if (provider.busy){
